...
class World extends React.Component{
    ...
    fetchData(){
      ...
      var url = (this.props.isSourceNYTimes) ? "http://localhost:8081/getNYTimesWorld" : "http://localhost:8081/getGuardianWorld";
    ...
    render(){
      ReactTooltip.rebuild()
        if(this.state.isLoaded){
          return(
            <>
            <NewsCards newsCardsInfo={this.state.newsCardsInfo} 
